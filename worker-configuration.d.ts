/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 795d2fb4cbfca332002650244cb1f7ff)
...
interface __BaseEnv_Env {
	...
	K6_RUNNER_ENAM: DurableObjectNamespace<import("./src/index").K6RunnerENAM>;
	K6_RUNNER_WNAM: DurableObjectNamespace<import("./src/index").K6RunnerWNAM>;
	K6_RUNNER_EEUR: DurableObjectNamespace<import("./src/index").K6RunnerEEUR>;
	K6_RUNNER_WEUR: DurableObjectNamespace<import("./src/index").K6RunnerWEUR>;
	K6_RUNNER_APAC: DurableObjectNamespace<import("./src/index").K6RunnerAPAC>;
	K6_RUNNER_SAM: DurableObjectNamespace<import("./src/index").K6RunnerSAM>;
	K6_RUN_WORKFLOW: Workflow<Parameters<import("./src/index").K6RunWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RunCoordinator" | "K6RunnerENAM" | "K6RunnerWNAM" | "K6RunnerEEUR" | "K6RunnerWEUR" | "K6RunnerAPAC" | "K6RunnerSAM";
	}
